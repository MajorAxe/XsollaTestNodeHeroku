...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('el-form',{ref:"addForm",staticClass:"fixed-width",attrs:{"model":_vm.form,"rules":_vm.rules,"label-width":"125px"}},[_c('el-row',{attrs:{"gutter":10}},[_c('el-col',{attrs:{"md":8}},[_c('el-form-item',{attrs:{"label":"Номер заказа","required":true,"prop":"orderNumber"}},[_c('el-input-number',{attrs:{"min":1,"controls":false},model:{value:(_vm.form.orderNumber),callback:function ($$v) {_vm.$set(_vm.form, "orderNumber", $$v)},expression:"form.orderNumber"}})],1)],1),_c('el-col',{attrs:{"md":16}},[_c('el-form-item',{attrs:{"label":"Цена","prop":"price"}},[_c('el-input',{staticClass:"input-with-select",attrs:{"type":"text"},model:{value:(_vm.form.price),callback:function ($$v) {_vm.$set(_vm.form, "price", $$v)},expression:"form.price"}},[_c('el-select',{attrs:{"slot":"append"},slot:"append",model:{value:(_vm.form.currency),callback:function ($$v) {_vm.$set(_vm.form, "currency", $$v)},expression:"form.currency"}},_vm._l((_vm.currencies),function(curr){return _c('el-option',{key:curr,attrs:{"value":curr}})}))],1)],1)],1)],1),_c('el-row',{attrs:{"gutter":10}},[_c('el-col',{attrs:{"md":24}},[_c('el-form-item',{attrs:{"label":"Номер карты","prop":"cardNumber"}},[_c('el-input',{directives:[{name:"mask",rawName:"v-mask",value:('####-##'),expression:"'####-##'"}],attrs:{"type":"text","prefix-icon":"el-icon-tickets"},model:{value:(_vm.form.cardNumber),callback:function ($$v) {_vm.$set(_vm.form, "cardNumber", $$v)},expression:"form.cardNumber"}})],1)],1)],1),_c('el-row',{attrs:{"gutter":10}},[_c('el-col',{attrs:{"md":24}},[_c('el-form-item',{attrs:{"label":"Имя владельца","prop":"name"}},[_c('el-input',{attrs:{"type":"text","prefix-icon":"el-icon-view","v-mask":'####-##'},model:{value:(_vm.form.name),callback:function ($$v) {_vm.$set(_vm.form, "name", $$v)},expression:"form.name"}})],1)],1)],1),_c('el-row',{attrs:{"gutter":10}},[_c('el-col',{attrs:{"md":12}},[_c('el-form-item',{attrs:{"label":"Expiration date","prop":"expiration"}},[_c('el-input',{attrs:{"type":"text","prefix-icon":"el-icon-date"},model:{value:(_vm.form.expiration),callback:function ($$v) {_vm.$set(_vm.form, "expiration", $$v)},expression:"form.expiration"}})],1)],1),_c('el-col',{attrs:{"md":12}},[_c('el-form-item',{attrs:{"label":"CVV","prop":"cvv"}},[_c('el-input',{attrs:{"type":"text","prefix-icon":"el-icon-setting"},model:{value:(_vm.form.cvv),callback:function ($$v) {_vm.$set(_vm.form, "cvv", $$v)},expression:"form.cvv"}})],1)],1)],1),_c('el-row',{attrs:{"gutter":10}},[_c('el-col',{attrs:{"md":12}},[_c('el-form-item',[_c('el-button',{attrs:{"type":"primary"},on:{"click":_vm.onSubmit}},[_vm._v("Добавить")])],1)],1)],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
/* harmony default export */ __webpack_exports__["a"] = (esExports);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_v_mask__ = __webpack_require__("1I9z");
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_6_v_mask__["a" /* default */]);
...
//# sourceMappingURL=app.461fc404c542f5bc91c5.js.map